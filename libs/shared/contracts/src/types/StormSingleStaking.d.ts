...
interface StormSingleStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class StormSingleStaking extends BaseContract {
  ...
  interface: StormSingleStakingInterface;
