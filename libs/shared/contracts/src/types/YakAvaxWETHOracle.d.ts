...
interface YakAvaxWETHOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakAvaxWETHOracle extends BaseContract {
  ...
  interface: YakAvaxWETHOracleInterface;
