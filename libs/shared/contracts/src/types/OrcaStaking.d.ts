...
export class OrcaStaking extends BaseContract {
  ...
  interface: OrcaStakingInterface;
  ...
  filters: {
    ChangedAddress(
      ...
      { addressType: string; oldAddress: string; newAddress: string }
    >;
    ...
    ChangedTreasury(
      oldTreasury?: string | null,
      newTreasury?: string | null
    ): TypedEventFilter<
      [string, string],
      { oldTreasury: string; newTreasury: string }
    >;
