...
interface YakAvaxBTCOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakAvaxBTCOracle extends BaseContract {
  ...
  interface: YakAvaxBTCOracleInterface;
