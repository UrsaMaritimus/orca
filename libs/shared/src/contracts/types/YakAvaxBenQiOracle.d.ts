...
interface YakAvaxBenQiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakAvaxBenQiOracle extends BaseContract {
  ...
  interface: YakAvaxBenQiOracleInterface;
