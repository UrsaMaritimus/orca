...
interface YakUsdcBenQiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakUsdcBenQiOracle extends BaseContract {
  ...
  interface: YakUsdcBenQiOracleInterface;
