...
interface YakBenqiBTCOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakBenqiBTCOracle extends BaseContract {
  ...
  interface: YakBenqiBTCOracleInterface;
