...
interface YakAvaxETHOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakAvaxETHOracle extends BaseContract {
  ...
  interface: YakAvaxETHOracleInterface;
