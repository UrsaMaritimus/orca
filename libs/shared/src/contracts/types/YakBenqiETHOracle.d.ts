...
interface YakBenqiETHOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakBenqiETHOracle extends BaseContract {
  ...
  interface: YakBenqiETHOracleInterface;
