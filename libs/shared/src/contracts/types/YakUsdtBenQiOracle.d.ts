...
interface YakUsdtBenQiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakUsdtBenQiOracle extends BaseContract {
  ...
  interface: YakUsdtBenQiOracleInterface;
