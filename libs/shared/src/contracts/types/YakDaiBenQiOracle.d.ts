...
interface YakDaiBenQiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakDaiBenQiOracle extends BaseContract {
  ...
  interface: YakDaiBenQiOracleInterface;
