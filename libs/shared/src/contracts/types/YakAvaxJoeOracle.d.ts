...
interface YakAvaxJoeOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakAvaxJoeOracle extends BaseContract {
  ...
  interface: YakAvaxJoeOracleInterface;
