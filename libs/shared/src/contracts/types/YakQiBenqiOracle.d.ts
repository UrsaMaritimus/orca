...
interface YakQiBenqiOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakQiBenqiOracle extends BaseContract {
  ...
  interface: YakQiBenqiOracleInterface;
