...
interface YakUsdcJoeOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class YakUsdcJoeOracle extends BaseContract {
  ...
  interface: YakUsdcJoeOracleInterface;
